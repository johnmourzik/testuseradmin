...
<html>
	...
	<form action="controller" method="post">
		...
		<tr><td>USER ID :</td><td><input type="text" id="userCode" name="userCode" placeholder="Enter only digits" required="required"></td></tr>
		<tr><td>USERNAME:</td><td><input type="text" name="userName" placeholder="Enter Alphabetics only" required></td></tr>
		<tr><td>USERSURNAME:</td><td><input type="text" name="userSurname" placeholder="Enter Alphabetics only" required></td></tr>
		<tr><td>BIRTHDAY:</td><td><input type="text" name="birthday" placeholder="Enter Alphabetics only" required></td></tr>
